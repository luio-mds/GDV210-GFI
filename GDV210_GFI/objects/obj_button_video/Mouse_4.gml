...
if (!instance_exists(obj_button_distort4))
{
instance_create_layer(100, 100, "Instances", obj_button_distort4);
instance_create_layer(100, 250, "Instances", obj_button_distort5);
instance_create_layer(100, 400, "Instances", obj_button_distort6);
}